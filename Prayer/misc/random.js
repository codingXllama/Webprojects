...
async function getPrayer() {
  ...
  const apiURL = `https://ca.mohid.co/on/windsor/abm/masjid/widget/api/index/?v=prayercalendar&date_from=${currentYear}-${monthNumber}-1&date_to=${currentYear}-${monthNumber}-31&show_iqamah=Y`;
